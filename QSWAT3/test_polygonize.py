...
import numpy as np
import os
from QSWAT.polygonize import Polygonize  # @UnresolvedImport
...
class TestPoly(unittest.TestCase):
    ...
    def test1(self):
        ...
        shapes = Polygonize(True, 3, -1, QgsPointXY(0,0), 1, 1)
    ...
    def test2(self):
        ...
        shapes = Polygonize(True, 5, -1, QgsPointXY(0,0), 1, 1)
...
#         shapes = Polygonize(QgsPoint(0,0), 1, 1)
...
#         shapes.finishShapesShapes(None)
    ...
    def test5(self):
        ...
        for isConnected4 in [True, False]:
            for _ in range(10000):
                shapes = Polygonize(isConnected4, size, -1, QgsPointXY(0,0), 1, 1)
                rows = []
                for r in range(size):
                    row = []
                    for _ in range(size):
