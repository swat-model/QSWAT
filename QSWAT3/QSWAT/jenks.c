 ...
 *         return
 */
  __pyx_tuple__9 = PyTuple_Pack(8, __pyx_n_s_data, __pyx_n_s_n_classes, __pyx_n_s_lower_class_limits, __pyx_n_s__8, __pyx_n_s_k, __pyx_n_s_kclass, __pyx_n_s_countNum, __pyx_n_s_elt); if (unlikely(!__pyx_tuple__9)) __PYX_ERR(0, 112, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_tuple__9);
  __Pyx_GIVEREF(__pyx_tuple__9);
  __pyx_codeobj__10 = (PyObject*)__Pyx_PyCode_New(2, 0, 8, 0, CO_OPTIMIZED|CO_NEWLOCALS, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__9, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_jenks_pyx, __pyx_n_s_jenks, 112, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__10)) __PYX_ERR(0, 112, __pyx_L1_error)
  __Pyx_RefNannyFinishContext();
  return 0;
  __pyx_L1_error:;
  __Pyx_RefNannyFinishContext();
